        ...
        <div className="space-y-4">
            ...
            >
                ...
                <span className="flex-1 text-left">
                    <span className="block font-medium dark:hover:text-white">Login as Demo Explorer</span>
                </span>
                {loading === "explorer" && (
            ...
            >
                ...
                <span className="flex-1 text-left">
                    <span className="block font-medium dark:hover:text-white">Login as Demo Admin</span>
                </span>
                {loading === "admin" && (
                    <span className="text-xs text-muted-foreground">Loading…</span>
                )}
