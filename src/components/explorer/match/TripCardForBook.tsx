...
// export default function TripCardForBook(trip:IAvailableTrip) {
//   const { id,
//   image,
//   destination,
//   title,
...
//           {travelStyleTags.map((tag:string) => (
//             <span
//               key={tag}
...
//             <div>
//               <Link href={`/dashboard/find-trips/${tripId}`}>
...
export default function TripCardForBook({
  tripId,
  image,
  destination,
  title,
